...
public class WaybillsControllerTests : IClassFixture<WaybillsControllerFixture>
{
    ...
    {
        var result = _waybillsControllerFixture.Instance.DeleteByIdAsync(Guid.Parse("BBB2AFB6-8ECF-4F63-9F98-71C3FC1B5F33"), CancellationToken.None);
    ...
    {
        var result = _waybillsControllerFixture.Instance.DeleteByIdAsync(Guid.Parse("BBB2AFB6-8ECF-4F63-9F98-71C3FC1B5F34"), CancellationToken.None);
