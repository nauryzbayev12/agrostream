...
public class WaybillsControllerFixture
{
    public WaybillsControllerFixture()
    {
        ...
        {
            cfg.CreateMap<Waybill, WaybillCreateDto>().ForMember(dest => dest.Items, opt => opt.MapFrom(src => src.Items)).ReverseMap();
            cfg.CreateMap<Waybill, WaybillDto>().ForMember(dest => dest.Items, opt => opt.MapFrom(src => src.Items)).ReverseMap();
            cfg.CreateMap<Waybill, WaybillUpdateDto>().ForMember(dest => dest.Items, opt => opt.MapFrom(src => src.Items)).ReverseMap();

            cfg.CreateMap<CargoItem, CargoItemDto>().ReverseMap();
            cfg.CreateMap<CargoItem, CargoItemCreateDto>().ReverseMap();
            cfg.CreateMap<CargoItem, CargoItemUpdateDto>().ReverseMap();

            cfg.CreateMap<CargoItem, CargoItemDto>().ReverseMap();
            cfg.CreateMap<CargoItem, CargoItemCreateDto>().ReverseMap();
            cfg.CreateMap<CargoItem, CargoItemUpdateDto>().ReverseMap();

            cfg.CreateMap<WaybillCreateRequest, WaybillCreateDto>().ReverseMap();
            cfg.CreateMap<WaybillUpdateRequest, WaybillUpdateDto>().ReverseMap();
            cfg.CreateMap<WaybillResponse, WaybillDto>().ReverseMap();

            cfg.CreateMap<CargoItemCreateRequest, CargoItemCreateDto>().ReverseMap();
            cfg.CreateMap<CargoItemUpdateRequest, CargoItemUpdateDto>().ReverseMap();
            cfg.CreateMap<CargoItemResponse, CargoItemDto>().ReverseMap();
        });
